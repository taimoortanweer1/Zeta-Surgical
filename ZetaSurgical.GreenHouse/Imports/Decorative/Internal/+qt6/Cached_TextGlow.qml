...
Item {
    ...
    DropShadow {
        ...
        radius: root.source ? root.source.glowRadius : 0.0
        spread: root.source ? root.source.spread : 0.0

        color: root.source ? root.source.glowColor : "black"

        source: root.source ? root.source.__textItem : null
    }

    property string cacheName: root.source ? root.source.__glowAsset : ""
    onCacheNameChanged: {
