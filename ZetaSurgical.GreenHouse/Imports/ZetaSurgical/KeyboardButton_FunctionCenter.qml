...
Item {
    ...
    Item {
        ...
        BorderImage {
            id: fi_Rectangle_361___invalid
            anchors.left: parent.left
            anchors.right: parent.right
            anchors.top: parent.top
            anchors.bottom: parent.bottom
            source: GreenHouseThemeManager.theme.asset("/212_8893.png")
            border.bottom: 10
            border.left: 10
            border.right: 10
            border.top: 10
    ...
    BorderImage {
        ...
        anchors.top: parent.top
        anchors.bottom: parent.bottom
        source: GreenHouseThemeManager.theme.asset("/210_4925.png")
        border.bottom: 10
        border.left: 10
        border.right: 10
        border.top: 10
    ...
    ComponentsSet.Label {
        ...
        z: 1
        height: 35
        text: qsTr(".?123", "FigmaNode::208:4916") + (typeof GreenHouseTestFixture !== 'undefined' && GreenHouseTestFixture !== null ? GreenHouseTestFixture.textId("FigmaNode::208:4916") : "")
    ...
    StateGroup { //
        ...
        State {
            ...
            PropertyChanges {
                ...
                border.right: 14
                border.top: 14
                source: GreenHouseThemeManager.theme.asset("/211_5205.png")
