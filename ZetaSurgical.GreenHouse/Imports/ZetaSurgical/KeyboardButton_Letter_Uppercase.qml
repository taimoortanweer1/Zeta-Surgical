...
Item {
    ...
    //FONT Figma::Arial_ArialMT_30_50_1_0_0_0_-0.6
    ...
    Item {
        ...
        BorderImage {
            ...
            anchors.top: parent.top
            anchors.bottom: parent.bottom
            source: GreenHouseThemeManager.theme.asset("/211_6855.png")
            border.bottom: 10
            border.left: 10
            border.right: 10
            border.top: 10
    ...
    BorderImage {
        ...
        anchors.top: parent.top
        anchors.bottom: parent.bottom
        source: GreenHouseThemeManager.theme.asset("/211_5635.png")
        border.bottom: 10
        border.left: 10
        border.right: 10
        border.top: 10
    ...
    ComponentsSet.Label {
        ...
        z: 1
        height: 48
        text: qsTr("Q", "FigmaNode::211:5636") + (typeof GreenHouseTestFixture !== 'undefined' && GreenHouseTestFixture !== null ? GreenHouseTestFixture.textId("FigmaNode::211:5636") : "")
        font: GreenHouseThemeManager.theme.font("Figma::Arial_ArialMT_30_50_1_0_0_0_-0.6")
    ...
    StateGroup { //
        ...
        State {
            ...
            PropertyChanges {
                ...
                border.right: 14
                border.top: 14
                source: GreenHouseThemeManager.theme.asset("/211_5642.png")
            }
        }
        ]
        transitions: [
