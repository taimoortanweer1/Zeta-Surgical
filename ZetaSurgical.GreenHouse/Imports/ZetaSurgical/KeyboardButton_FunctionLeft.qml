...
Item {
    ...
    Item {
        ...
        BorderImage {
            ...
            anchors.top: parent.top
            anchors.bottom: parent.bottom
            source: GreenHouseThemeManager.theme.asset("/212_8896.png")
            border.bottom: 10
            border.left: 10
            border.right: 10
            border.top: 10
    ...
    BorderImage {
        ...
        anchors.top: parent.top
        anchors.bottom: parent.bottom
        source: GreenHouseThemeManager.theme.asset("/210_4923.png")
        border.bottom: 10
        border.left: 10
        border.right: 10
        border.top: 10
    ...
    ComponentsSet.Label {
        ...
        anchors.bottomMargin: 16
        z: 1
        text: qsTr("tab", "FigmaNode::208:4909") + (typeof GreenHouseTestFixture !== 'undefined' && GreenHouseTestFixture !== null ? GreenHouseTestFixture.textId("FigmaNode::208:4909") : "")
    ...
    StateGroup { //
        ...
        State {
            ...
            PropertyChanges {
                ...
                border.right: 14
                border.top: 14
                source: GreenHouseThemeManager.theme.asset("/211_5202.png")
            }
        }
        ]
    }
