...
Item {
    ...
    //ASSET /Icons/UpTriangle__DefaultState.png
    ...
    BorderImage {
        ...
        anchors.top: parent.top
        anchors.bottom: parent.bottom
        source: GreenHouseThemeManager.theme.asset("/48_2012.png")
        border.bottom: 10
        border.left: 10
        border.right: 10
        border.top: 10
    ...
    Image {
        ...
        anchors.bottom: parent.bottom
        z: 1
        source: GreenHouseThemeManager.theme.asset("/Icons/UpTriangle__DefaultState.png")
    ...
    StateGroup { //
        ...
        State {
            ...
            PropertyChanges {
                ...
                border.right: 14
                border.top: 14
                source: GreenHouseThemeManager.theme.asset("/164_7347.png")
            }
            PropertyChanges {
                target: pressed_StateParent
                visible: true
