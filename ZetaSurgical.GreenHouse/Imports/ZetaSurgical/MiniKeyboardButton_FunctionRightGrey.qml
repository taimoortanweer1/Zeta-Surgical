...
Item {
    ...
    BorderImage {
        ...
        anchors.top: parent.top
        anchors.bottom: parent.bottom
        source: GreenHouseThemeManager.theme.asset("/614_3477.png")
        border.bottom: 10
        border.left: 10
        border.right: 10
        border.top: 10
    ...
    ComponentsSet.Label {
        ...
        z: 1
        text: qsTr("shift", "FigmaNode::614:3478") + (typeof GreenHouseTestFixture !== 'undefined' && GreenHouseTestFixture !== null ? GreenHouseTestFixture.textId("FigmaNode::614:3478") : "")
    ...
    StateGroup { //
        ...
        State {
            ...
            PropertyChanges {
                ...
                border.right: 14
                border.top: 14
                source: GreenHouseThemeManager.theme.asset("/614_3487.png")
            }
        }
        ]
        transitions: [
