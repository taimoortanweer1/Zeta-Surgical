...
Item {
    ...
    Item {
        ...
        BorderImage {
            ...
            anchors.top: parent.top
            anchors.bottom: parent.bottom
            source: GreenHouseThemeManager.theme.asset("/212_8899.png")
            border.bottom: 10
            border.left: 10
            border.right: 10
            border.top: 10
    ...
    BorderImage {
        ...
        anchors.top: parent.top
        anchors.bottom: parent.bottom
        source: GreenHouseThemeManager.theme.asset("/211_5004.png")
        border.bottom: 10
        border.left: 10
        border.right: 10
        border.top: 10
    ...
    ComponentsSet.Label {
        ...
        anchors.bottomMargin: 16
        z: 1
        text: qsTr("shift", "FigmaNode::211:5005") + (typeof GreenHouseTestFixture !== 'undefined' && GreenHouseTestFixture !== null ? GreenHouseTestFixture.textId("FigmaNode::211:5005") : "")
    ...
    StateGroup { //
        ...
        State {
            ...
            PropertyChanges {
                ...
                border.right: 14
                border.top: 14
                source: GreenHouseThemeManager.theme.asset("/211_5212.png")
            }
        }
        ]
        transitions: [
