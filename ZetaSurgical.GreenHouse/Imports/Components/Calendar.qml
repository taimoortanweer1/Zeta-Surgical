...
Item {
    ...
    //FONT textFont
    property font monthTitleFont: GreenHouseThemeManager.theme.font("textFont")
    //FONT textFont
    property font dayOfWeekTitleFont: GreenHouseThemeManager.theme.font("textFont")
    //COLOR textColor
    property color monthTitleColor: GreenHouseThemeManager.theme.color("textColor")
    //COLOR textColor
    property color dayOfWeekTitleColor: GreenHouseThemeManager.theme.color("textColor")
                ...
                Repeater {
                    ...
                    Loader {
                        ...
                        Connections {
                            ...
                            function onClicked() { root.dateClicked(root.year, daysItem.montIndex, index) }
                        }
                    }
                }
            }
