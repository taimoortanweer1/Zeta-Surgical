...
Item {
    ...
    property string knobMinSource: GreenHouseThemeManager.theme.asset("/placeholders/slider/knob.png")
    //ASSET /placeholders/slider/knob.png
    property string knobMaxSource: GreenHouseThemeManager.theme.asset("/placeholders/slider/knob.png")
    //ASSET
    property string fillSource: ""
    //ASSET
    property string bubbleMinSource: ""
    //ASSET
    property string bubbleMaxSource: ""
