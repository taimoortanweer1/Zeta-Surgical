...
Item {
    ...
    property string backgroundAsset: GreenHouseThemeManager.theme.asset("/placeholders/switch/bg_hover.png")
    //ASSET /placeholders/switch/bg_hover.png
    property string backgroundHoveredAsset: GreenHouseThemeManager.theme.asset("/placeholders/switch/backgroundHoveredAsset.png")
    //ASSET /placeholders/switch/handle.png
    property string handleAsset: GreenHouseThemeManager.theme.asset("/placeholders/switch/handle.png")
    //ASSET /placeholders/switch/handle_active.png
    property string handleActiveAsset: GreenHouseThemeManager.theme.asset("/placeholders/switch/handle_active.png")
