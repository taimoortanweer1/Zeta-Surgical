...
Item {
    ...
    //COLOR panelColor
    property color color: GreenHouseThemeManager.theme.color("panelColor")
    //COLOR alternativePanelColor
    property color alternativeColor: GreenHouseThemeManager.theme.color("alternativePanelColor")
