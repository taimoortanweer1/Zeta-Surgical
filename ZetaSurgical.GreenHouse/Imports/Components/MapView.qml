...
Item {
    ...
    //COLOR textColor
    property color routeLineColor: GreenHouseThemeManager.theme.color("textColor")
    ...
    Component {
        ...
        Item {
            ...
            Map {
                ...
                Connections {
                    target: root
                    function onRoutePointListChanged() { map.updateRoute() }
                    function onTravelByCarChanged() { map.updateRoute() }
                    function onTravelByFootChanged() { map.updateRoute() }
                    function onTravelByBicycleChanged() { map.updateRoute() }
                    function onTravelByPublicTransitChanged() { map.updateRoute() }
                    function onTravelByTruckChanged() { map.updateRoute() }
                    function onOfflineRouteEnabledChanged() { map.updateRoute() }
                }
                MouseArea {
                    anchors.fill: parent
                    onPressAndHold:  {
